...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to GrayHunt, a crawler-driven intelligence agent. With crawler and analysis skills, GrayHunt helps you collect cross-platform signals, extract black/gray market entities, and generate actionable intelligence reports.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own crawler or analysis skill to extend GrayHunt. Custom skills can add new platforms, risk rules, parsers, and report templates.",
  },
  ...
  agents: {
    ...
    saving: "Saving agent...",
    saveRequested:
      "Save requested. GrayHunt is generating and saving an initial version now.",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "The agent was created, but GrayHunt could not load it yet. Please refresh this page in a moment.",
    more: "More actions",
  ...
  // Workspace
  workspace: {
    officialWebsite: "GrayHunt's official website",
    githubTooltip: "GrayHunt on Github",
    settingsAndMore: "Settings and more",
    visitGithub: "GrayHunt on GitHub",
    reportIssue: "Report a issue",
    contactUs: "Contact us",
    about: "About GrayHunt",
    logout: "Log out",
  },
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "Install skill and make it available to GrayHunt",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate GrayHunt faster with keyboard shortcuts.",
  ...
  settings: {
    title: "Settings",
    description: "Adjust how GrayHunt looks and behaves for you.",
    sections: {
      account: "Account",
    ...
    memory: {
      title: "Memory",
      description:
        "GrayHunt automatically learns from your conversations in the background. These memories help GrayHunt understand your investigations and deliver a more personalized experience.",
    ...
    skills: {
      ...
      emptyDescription:
        "Put your crawler or analysis skill folders under the `/skills/custom` folder under the root folder of GrayHunt.",
      emptyButton: "Create Your First Skill",
    },
    notification: {
      title: "Notification",
      description:
        "GrayHunt only sends a completion notification when the window is not active. This is especially useful for long-running crawls and analysis jobs so you can switch to other work and get notified when done.",
