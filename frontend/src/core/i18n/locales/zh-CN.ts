...
export const zhCN: Translations = {
  ...
  welcome: {
    greeting: "你好，欢迎回来！",
    description:
      "欢迎使用 GrayHunt，一个通过爬虫采集多平台情报、抽取黑灰产实体并生成分析报告的智能体。",

    createYourOwnSkill: "创建你自己的 Agent SKill",
    createYourOwnSkillDescription:
      "创建你的爬虫或分析 Skill 来扩展 GrayHunt。自定义技能可以加入新平台、风险规则、解析器和报告模板。",
  },
  ...
  agents: {
    ...
    saving: "正在保存智能体...",
    saveRequested:
      "已提交保存请求，GrayHunt 正在根据当前对话生成并保存初版智能体。",
    saveHint:
    ...
    agentCreatedPendingRefresh:
      "智能体已创建，但 GrayHunt 暂时还无法读取到它。请稍后刷新当前页面。",
    more: "更多操作",
    agentCreated: "智能体已创建！",
    startChatting: "开始对话",
  ...
  // Workspace
  workspace: {
    officialWebsite: "访问 GrayHunt 官方网站",
    githubTooltip: "访问 GrayHunt 的 Github 仓库",
    settingsAndMore: "设置和更多",
    visitGithub: "在 Github 上查看 GrayHunt",
    reportIssue: "报告问题",
    contactUs: "联系我们",
    about: "关于 GrayHunt",
    logout: "退出登录",
  ...
  toolCalls: {
    ...
    skillInstallTooltip: "安装技能并使其可在 GrayHunt 中使用",
  },
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription: "使用键盘快捷键更快地操作 GrayHunt。",
  ...
  settings: {
    title: "设置",
    description: "根据你的偏好调整 GrayHunt 的界面和行为。",
    sections: {
      account: "账号",
      appearance: "外观",
      memory: "记忆",
    ...
    memory: {
      title: "记忆",
      description:
        "GrayHunt 会在后台不断从你的对话中自动学习。这些记忆能帮助 GrayHunt 更好地理解你的调查任务，并提供更个性化的体验。",
      empty: "暂无可展示的记忆数据。",
      rawJson: "原始 JSON",
      exportButton: "导出记忆",
      exportSuccess: "记忆已导出",
    ...
    skills: {
      ...
      emptyTitle: "还没有技能",
      emptyDescription:
        "将你的爬虫或分析 Skill 文件夹放在 GrayHunt 根目录下的 `/skills/custom` 文件夹中。",
      emptyButton: "创建你的第一个技能",
    },
    notification: {
      title: "通知",
      description:
        "GrayHunt 只会在窗口不活跃时发送完成通知，特别适合长时间爬取和分析任务：你可以先去做别的事，完成后会收到提醒。",
